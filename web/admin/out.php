...
class outBatsman
{
  ...
  private $extrawicket;
	...
	public function out($outtype)
	{
       ...
       {
          $this->bowlername="c b".$this->bowlername;
          $sql="UPDATE  status  SET out_type='$this->bowlername',stricking_role=NULL WHERE status_id=$this->statusid";
          $result=DB::getConnection()->update($sql);
       }
       ...
       else if($this->outtype==5)
       {
          $this->bowlername="lbw b".$this->bowlername;
          $sql="UPDATE  status  SET out_type='$this->bowlername',stricking_role=NULL WHERE status_id=$this->statusid";
          $result=DB::getConnection()->update($sql);
       }
       ...
       else if($this->outtype==7)
       {
          $this->bowlername="hitw b".$this->bowlername;
          $sql="UPDATE  status  SET out_type='$this->bowlername',stricking_role=NULL WHERE status_id=$this->statusid";
          $result=DB::getConnection()->update($sql);
       }
       ...
       if($this->outtype==1 || $this->outtype==2 ||  $this->outtype==5 || $this->outtype==6 || $this->outtype==7)
       {
